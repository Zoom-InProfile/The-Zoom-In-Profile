...
const categoryMeta = {
 ...
 perception: {
  ...
  balance: {
    ...
    mirror: 'Your primary stress pattern is Balance-Sensitive. People in the Balance category have a finely tuned internal sense of what a sustainable life feels like, and they notice quickly when something tips that equilibrium. This isn\'t about having a small container or low tolerance for hard work. It\'s about a nervous system that is particularly sensitive to the perception of too much. For some people in this category a perfectionism quality amplifies this, keeping the weight of each item elevated because everything feels like it needs to be done completely and well. When the nervous system tips in this pattern, the organizing clarity that normally helps you sort and sequence goes quiet, and what\'s left is feeling stuck, where everything feels equally urgent, and there is nowhere obvious to start. The Zoom-Out work for this pattern is about learning to see the pile more accurately, separating what genuinely needs your full attention from what your nervous system is making heavier than it needs to be.'
  },
  comfort: {
